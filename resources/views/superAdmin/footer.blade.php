                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="mb-4">
                            <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                {{ App::getLocale() === 'en' ? 'Email' : 'Mejl adresa' }}
                            </label>
                            <input
                                type="email"
                                id="email"
            ...
            <div class="border border-gray-300 dark:border-gray-600 rounded-lg p-4">
                <div class="mb-4">
                    <label class="mr-4 text-gray-700 dark:text-gray-300">
                        <input type="radio" name="preview-lang" value="sr" checked> {{ App::getLocale() === 'en' ? 'Serbian' : 'Srpski' }}
                    </label>
                    <label class="text-gray-700 dark:text-gray-300">
                        <input type="radio" name="preview-lang" value="en"> {{ App::getLocale() === 'en' ? 'English' : 'Engleski' }}
                    </label>
                </div>
                            ...
                            <div class="flex-grow md:flex-grow-0 md:basis-1/3 mb-6 md:mb-0">
                                <a class="flex flex-col items-start">
                                    ...
                                    <div class="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                        <p><span id="preview-address_label">{{ $libraryData['address_label'] ?? (App::getLocale() === 'en' ? 'Address' : 'Adresa') }}:</span> <span id="preview-address">{{ $libraryData['address'] ?? '' }}</span></p>
                                        <p><span id="preview-pib_label">{{ $libraryData['pib_label'] ?? (App::getLocale() === 'en' ? 'Tax ID (PIB)' : 'PIB') }}:</span> <span id="preview-pib">{{ $libraryData['pib'] ?? '' }}</span></p>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4 mt-2">
                                        <a id="preview-facebook" href="{{ $libraryData['facebook'] ?? '#' }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="Facebook page">
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 8 19" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a id="preview-twitter" href="{{ $libraryData['twitter'] ?? '#' }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="Twitter page">
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 8 19" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M20 1.892a8.178 8.178 0 0 1-2.355 0.635 4.074 4.074 0 0 0 1.8-2.235 8.344 8.344 0 0 1-2.605.98A4.13 4.13 0 0 0 13.85 0a4.068 4.068 0 0 0-4.1 4.038 4 4 0 0 0 .105.919A11.705 11.705 0 0 1 1.4.734a4.006 4.006 0 0 0 1.268 5.392 4.165 4.165 0 0 1-1.859-.5v.05A4.057 0 0 0 4.1 9.635a4.19 4.19 0 0 1-1.856.07 4.108 4.108 0 0 0 3.831 2.807A8.36 8.36 0 0 1 0 14.184 11.732 11.732 0 0 0 6.291 16 11.502 11.502 0 0 0 17.964 4.5c0-.177 0-.35-.012-.523A8.143 8.143 0 0 0 20 1.892Z" clip-rule="evenodd"/>
                                            </svg>
                                        </a>
                                        <a id="preview-email-link" href="mailto:{{ $libraryData['email'] ?? 'dositejbib@gmail.com' }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="Email">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 8 19" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a4 4 0 0 0 3.24 0L21 8m-18 0v8-8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8M3 8V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v2"/>
                                            </svg>
                                        </a>
                                    </div>
                                </div>
