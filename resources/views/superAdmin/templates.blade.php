<x-app-layout>
    <div x-data="{ open: false }" class="min-h-[90vh] w-full flex items-start justify-center p-2 px-4 sm:px-6 lg:px-8">
            ...
            <div>
                <div class="p-2 sm:p-4 lg:p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 lg:gap-6">
                        ...
                        <div class="bg-slate-800 max-w-sm rounded-lg shadow-sm border transition duration-300 hover:-translate-y-1 hover:scale-105 group overflow-hidden">
                            <div>
                            ...
                            <div class="p-5 flex flex-col justify-between flex-grow">
                                ...
                                <a href="#" class="w-fit inline-flex items-center px-3 py-2 text-sm font-medium text-center rounded-lg bg-[var(--accent)] hover:bg-[color-mix(in_srgb,_var(--accent)_80%,_black_20%)]">
