                ...
                <p class="text-gray-700 dark:text-gray-300 space-y-2">
                    {!! App::getLocale() === 'en'
                        ? 'On this page, you can <strong>change the information</strong> displayed in <strong>the header</strong> of your page.<br>
                            ...
                            In the first form, you should enter the information in Serbian, and then the system will <strong>automatically translate</strong> the information into English. You can <strong>review</strong> and, if necessary, <strong>edit</strong> it in the form for the English language.<br>
