        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (confirmDeleteButton) {
                confirmDeleteButton.addEventListener('click', () => {
                    if (!currentStructId) {
                        alert('ID dokumenta nije definisan.');
                        return;
                    }
                    ...
                    .catch(error => {
                        alert('Greška prilikom brisanja dokumenta: ' + error.message);
                    });
                });
            }
            ...
            if (confirmRenameButton) {
                confirmRenameButton.addEventListener('click', () => {
                    ...
                    .catch(error => {
                        alert('Greška prilikom preimenovanja dokumenta: ' + error.message);
                    });
                });
            }
                ...
                uploadForm.addEventListener('submit', (e) => {
                    ...
                    .then(data => {
                        if (data.message) {
                            ...
                            alert('Došlo je do greške: ' + (data.message || 'Nepoznata greška'));
                            submitButton.disabled = false;
                            if (spinner) spinner.classList.add('hidden');
                        }
                    })
                    .catch(error => {
                        ...
                        alert('Greška prilikom učitavanja dokumenta: ' + error.message);
                        submitButton.disabled = false;
                        if (spinner) spinner.classList.add('hidden');
                    });
                });
