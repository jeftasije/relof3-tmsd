                        ...
                        <div class="flex items-center justify-center w-full" style="min-height: 140px;">
                            ...
                            <div class="flex-1 flex justify-center items-center min-h-[120px] cursor-zoom-in">
                                <template x-if="slide === 1">
                                    <img @click="enlarged = '/images/extendedNews-help1.png'" src="/images/extendedNews-help1.png" alt="Edit Button" class="rounded-xl max-h-36 object-contain bg-transparent transition-all duration-300 shadow hover:scale-105" />
                                </template>
                                <template x-if="slide === 2">
                                    <img @click="enlarged = '/images/extendedNews-help2.png'" src="/images/extendedNews-help2.png" alt="Edit Modal" class="rounded-xl max-h-36 object-contain bg-transparent transition-all duration-300 shadow hover:scale-105" />
                                </template>
                            </div>
                        ...
                        <template x-if="slide === 1">
                            <div>
                                ...
                                <p>
                                    ...
                                    @case('en')
                                        To edit the extended news, click the "Edit" button located at the top right of the news image (see image 1).
                                    @break
                                    @case('sr-Cyrl')
                                        Да бисте изменили проширену вест, кликните на дугме „Измени“ у горњем десном углу слике вести (слика 1).
                                    @break
                                    @default
                                        Da biste izmenili proširenu vest, kliknite na dugme „Izmeni“ u gornjem desnom uglu slike vesti (slika 1).
                                    @endswitch
                                </p>
                            </div>
                        </template>
