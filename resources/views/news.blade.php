    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full p-4" id="header" style="background: var(--primary-bg);">
            ...
            <button id="theme-toggle" class="p-2 rounded-full"
                style="color: var(--primary-text); background: var(--primary-bg);"></button>
        </div>
    </x-slot>

    <div 
        x-data
        x-init="$store.modals && $store.modals.closeAll && $store.modals.closeAll()"
        class="min-h-[90vh] w-full flex flex-col items-center"
        ...
        <div class="w-full max-w-screen-xl mx-auto">
            ...
            <div class="p-2 sm:p-4 lg:p-6">
                ...
                <div class="flex justify-end mb-6">
                    @auth
                        <button @click="$store.modals.openAddNews()" class="flex items-center gap-1 font-semibold py-2 px-4 rounded-lg shadow"
        ...
        >
            ...
            >
                ...
                <div class="flex flex-col flex-1 px-4 py-3 overflow-hidden h-full">
                    ...
                    <div x-show="enlarged" x-transition x-cloak class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80"
...
<script>
    function initAlpineModalsStore() {
        ...
        if (!Alpine.store('modals')) {
            Alpine.store('modals', {
                open: false,
                helpOpen: false,
                openAddNews() { this.open = true; this.helpOpen = false; },
                openHelp() { this.helpOpen = true; this.open = false; },
                closeAll() { this.open = false; this.helpOpen = false; }
            });
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('[x-show]').forEach(function(e) {
            e.style.display = 'none';
        });

        document.addEventListener('click', function(e) {
            if (e.target.matches('.pagination a, .pagination li a')) {
                e.preventDefault();
