                                ...
                                <div class="flex items-center justify-center w-full" style="min-height: 170px;">
                                    ...
                                    <div class="flex-1 flex justify-center items-center min-h-[150px] cursor-zoom-in">
                                        <template x-if="slide === 1">
                                            <img @click="enlarged = '/images/news-help1.png'" src="/images/news-help1.png"
                                                alt="Edit or Delete News"
                                        ...
                                        <template x-if="slide === 2">
                                            <img @click="enlarged = '/images/news-help2.png'" src="/images/news-help2.png"
                                                alt="Edit Form"
                                                class="rounded-xl max-h-52 object-contain bg-transparent transition-all duration-300 shadow hover:scale-105" />
                                        </template>
                                        <template x-if="slide === 3">
                                            <img @click="enlarged = '/images/news-help3.png'" src="/images/news-help3.png"
                                                alt="Add News"
                                                class="rounded-xl max-h-52 object-contain bg-transparent transition-all duration-300 shadow hover:scale-105" />
                                        </template>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            @switch(App::getLocale())
                                                @case('en')
                                                    To edit or delete a news item, click the three dots located at the bottom left
                                                    corner of the news card. This will open a menu with options for editing and
                                                    deleting.
                                                @break

                                                @case('sr-Cyrl')
                                                    Да бисте измењили или обрисали вест, кликните на три тачке у доњем левом углу
                                                    компоненте вести. Појавиће се мени са опцијама за измену и брисање.
                                                @break

                                                @default
                                                    Da biste izmenili ili obrisali vest, kliknite na tri tačke u donjem levom uglu
                                                    komponente vesti. Pojaviće se meni sa opcijama za izmenu i brisanje.
                                            @endswitch
                                        </p>
                                    </div>
                                </template>
                                <template x-if="slide === 2">
                                    <div>
                                        ...
                                        <p>
                                            @switch(App::getLocale())
                                                @case('en')
                                                    After clicking Edit, you can modify the text fields. You can also click on the
                                                    news image to upload a different image. Once you have finished making changes,
                                                    click Save to update the news.<br>
                                                    If you wish to discard your changes at any moment, click Cancel. You will
                                                    receive a confirmation message after successful editing.
                                                @break

                                                @case('sr-Cyrl')
                                                    Након што кликнете на Измени, можете измењивати текстуална поља, као и кликнути
                                                    на слику вести да бисте отпремили нову. По завршетку измена кликните на дугме
                                                    Сачувај.<br>
                                                    Ако желите да одустанете од промена у било ком тренутку, кликните на дугме
                                                    Откажи. Након успешне измене, добићете потврду о сачуваним променама.
                                                @break

                                                @default
                                                    Nakon što kliknete na Izmeni, možete izmeniti tekstualna polja, a klikom na
                                                    sliku vesti možete izabrati novu. Kada završite izmene, kliknite na Sačuvaj.<br>
                                                    Ako želite da otkažete izmene u bilo kom trenutku, kliknite na dugme Otkaži.
                                                    Nakon uspešne izmene, dobijate poruku o sačuvanim promenama.
                                            @endswitch
                                        </p>
                                    </div>
                                </template>
                                <template x-if="slide === 3">
                                    <div>
                                        ...
                                        <p>
                                            @switch(App::getLocale())
                                                @case('en')
                                                    To add a new news item, click the "Add News" button. Complete the fields for the
                                                    basic news content, and use the fields on the right for extended news
                                                    content.<br>
                                                    Depending on the currently selected language, enter the content in that
                                                    language; the system will automatically translate and save the content in the
                                                    other languages.<br>
                                                    After creating a news item, click "Show more" to view the detailed news you
                                                    entered.
                                                @break

                                                @case('sr-Cyrl')
                                                    Да додате нову вест, кликните на дугме "Додај вест". Попуните колоне за основну
                                                    и проширену вест.<br>
                                                    У зависности од изабраног језика, уносите садржај на том језику; систем ће
                                                    аутоматски превести и сачувати садржај и на другим језицима.<br>
                                                    Након креирања вести, кликните на "Прикажи више" како бисте видели детаљну вест
                                                    коју сте унели.
                                                @break

                                                @default
                                                    Da dodate novu vest, kliknite na dugme "Dodaj vest". Popunite kolone za osnovnu
                                                    i proširenu vest.<br>
                                                    U zavisnosti od izabranog jezika, unosite sadržaj na tom jeziku; sistem će
                                                    automatski prevesti i sačuvati sadržaj i na drugim jezicima.<br>
                                                    Nakon kreiranja vesti, kliknite na "Prikaži više" da detaljno vidite proširenu
                                                    vest koju ste uneli.
                                            @endswitch
                                        </p>
                                    </div>
        ...
        function initAlpineModalsStore() {
            ...
            if (!Alpine.store('modals')) {
                Alpine.store('modals', {
                    ...
                    helpOpen: false,
                    openAddNews() {
                        this.addNewsOpen = true;
                        this.helpOpen = false;
                    },
                    openHelp() {
                        this.helpOpen = true;
                        this.addNewsOpen = false;
                    },
                    closeAll() {
                        this.addNewsOpen = false;
                        this.helpOpen = false;
