<x-guest-layout>
    ...
    <div style="background: var(--primary-bg) !important; min-height: 90vh;" class="w-full flex items-start justify-center p-2 px-4 sm:px-6 lg:px-8" x-data>
        <div class="w-full max-w-screen-xl mx-auto">
            ...
            <div
                x-show="$store.modals.addEmployeeOpen"
                x-transition
                            ...
                            <div class="flex items-center justify-center w-full" style="min-height: 170px;">
                                ...
                                <div class="flex-1 flex justify-center items-center min-h-[150px] cursor-zoom-in">
                                    <template x-if="slide === 1">
                                        <img @click="enlarged = '/images/employee-help1.png'" src="/images/employee-help1.png" alt="Edit or Delete Employees" class="rounded-xl max-h-52 object-contain bg-transparent transition-all duration-300 shadow hover:scale-105" />
                                    </template>
                                    ...
                                    <template x-if="slide === 3">
                                        <img @click="enlarged = '/images/employee-help3.png'" src="/images/employee-help3.png" alt="Add Employee" class="rounded-xl max-h-52 object-contain bg-transparent transition-all duration-300 shadow hover:scale-105" />
                                    </template>
                                </div>
        ...
        function initAlpineModalsStore() {
            ...
            if (!Alpine.store('modals')) {
                Alpine.store('modals', {
                    ...
                    helpOpen: false,
                    openAddEmployee() { this.addEmployeeOpen = true; this.helpOpen = false; },
                    openHelp() { this.helpOpen = true; this.addEmployeeOpen = false; },
                    closeAll() { this.addEmployeeOpen = false; this.helpOpen = false; }
                });
            }
        }
