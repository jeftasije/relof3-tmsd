            ...
            <div class="relative z-10 py-8 lg:py-16 px-6 mx-auto max-w-screen-md 
                ...
                @auth
                    <form action="{{ route('contact.update') }}" method="POST" class="space-y-6 mb-10">
                        ...
                        <!--<textarea id="text_sr" name="text_sr" rows="5" required class="w-full p-4 bg-white dark:bg-
                        gray-800 border rounded shadow-sm focus:ring focus:outline-none
                         dark:text-white" style="text-align: center;">{{trim(old('text_sr', $content->text_sr ?? ''))}}</textarea>-->
