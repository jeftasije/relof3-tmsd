            ...
            <div class="flex">
                ...
                <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidenav">
                    <div class="flex flex-row items-center justify-between">
                        <div class="ml-5 scale-[0.5] origin-left">
                            <x-application-logo />
                        </div>
                        <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 h-10 w-10 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    ...
                    <div class="overflow-y-auto px-3 h-full">
                        <ul class="space-y-2">
                            <li>
                                ...
                                <ul id="dropdown-pages-1" class="hidden py-2 ml-5 space-y-2">
                                    <li>
                                        <a href="{{ route('header.show') }}" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        ...
                        <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <li>
                                <a href="/pregled-zalbi" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                    ...
                    <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
                        ...
                        <button id="theme-toggle" type="button"
                            class="rounded-lg text-sm p-1.5 md:p-2.5 mx-1 md:mx-6 bg-white dark:bg-gray-800">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('documents.index')" :active="request()->routeIs('documents.index')">
                        @switch(App::getLocale())
                        @case('en') Upload the document @break
                        @case('sr-Cyrl') Објави документ @break
                        @default Objavi dokument
                        @endswitch
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
