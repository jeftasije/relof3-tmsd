  ...
  <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
    <div class="flex flex-col md:flex-row md:justify-between md:flex-wrap gap-6">
      ...
      <div class="flex-grow md:flex-grow-0 md:basis-1/3 mb-6 md:mb-0">
        <a class="flex flex-col items-start">
          ...
          <div class="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            <p>Adresa: Stevana Nemanje 2, 36300 Novi Pazar</p>
            <p>PIB: 101234567</p>
          </div>
        </a>
      </div>
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 md:basis-1/3 flex-grow">
        <div>
          <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Radno vreme</h2>
          <ul class="text-gray-500 dark:text-gray-400 font-medium">
            <li>PON - SUB : 8:00 - 16:00</li>
            <li>NED : neradna</li>
          </ul>
        </div>

        <div>
          <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Kontakt</h2>
          <ul class="text-gray-500 dark:text-gray-400 font-medium space-y-2 mb-4">
            <li><i class="fas fa-phone me-2"></i> +381 (0)20 331 010</li>
            <li><i class="fas fa-envelope me-2"></i> dositejbib@gmail.com</li>
          </ul>

          <div class="flex space-x-4 mt-2">
            <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="Facebook page">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 8 19" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
              </svg>
            </a>
            <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="Twitter page">
            ...
            <a href="mailto:dositejbib@gmail.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="Email">
      ...
      <div class="mt-6 md:mt-0 md:basis-1/4 w-full md:w-auto">
        <iframe
          src="https://www.google.com/maps?q=Stevana+Nemanje+2,+Novi+Pazar&output=embed"
          width="100%"
          height="200"
          style="border:0;"
          allowfullscreen=""
    ...
    <div class="text-center mt-4 text-sm text-gray-500 dark:text-gray-400">
      © 2023 <a href="https://flowbite.com/" class="hover:underline">Narodna biblioteka "Dositej Obradović"</a>.
    </div>
  </div>
</footer>
